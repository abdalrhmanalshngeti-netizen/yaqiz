...
router.post('/',                    can('customers.manage'), requireFeature('customers'), ctrl.create);
router.get ('/:id',                 can('customers.view'),   ctrl.getOne);
router.put ('/:id',                 can('customers.manage'), requireFeature('customers'), ctrl.update);
router.delete('/:id',               can('customers.manage'), requireFeature('customers'), ctrl.remove);
