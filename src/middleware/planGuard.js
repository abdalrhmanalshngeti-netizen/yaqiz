...
const PLAN_FEATURES = {
  basic:   [],
  growth:  ['employees','payroll','shifts','import','activity_log','cashflow','custom_period','stock_moves','admin_expenses','ai_extract','ai_analyze','customers','period_close','obligations','purchase_orders'],
